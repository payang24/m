...
<div class='well'>
  ...
  <?php $form = ActiveForm::begin([
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="exampleInputAmount" placeholder="กรุณาใส่ข้อมูล" name="cid" value="<?=$cid?>">
    </div>
  </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        echo GridView::widget([
            ...
            'panel' => [
                'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i> ข้อมูลบริการสุขภาพ : '.$fname.'</h3>',
                'type' => 'success',
                'footer' => false],
